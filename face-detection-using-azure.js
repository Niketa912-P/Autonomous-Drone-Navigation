...
key = "60a7271afe5047449aa557c7173eb607"
endpoint = "https://niketa.cognitiveservices.azure.com/"

const credentials = new msRest.ApiKeyCredentials({ inHeader: { 'Ocp-Apim-Subscription-Key': key } });
const client = new Face.FaceClient(credentials, endpoint);

const image_base_url = "https://facedetectionnik.blob.core.windows.net/n-v/";
...
async function DetectFaceExtract() {
    ...
    const image_file_names = [
        ...
        // "1.png" // (optional: single man)
         //"2.png" // (optional: single male construction worker)
        // "detection4.jpg", // (optional: 3 people at cafe, 1 is blurred)
        "download.png"    // family, woman child man
...
// NOTE await does not work properly in for, forEach, and while loops. Use Array.map and Promise.all instead.
    await Promise.all (image_file_names.map (async function (image_file_name) {
        console.log(image_base_url + image_file_name);
